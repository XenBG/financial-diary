<template>
    <TransitionRoot :show="showDeleteExpenseModal" appear as="template">
...
<script setup>
    ...
    // State
    const showDeleteExpenseModal = computed({
        get: () => modalsStore.showDeleteExpenseModal,
        set: (value) => {
            modalsStore.showDeleteExpenseModal = value
        },
    })
