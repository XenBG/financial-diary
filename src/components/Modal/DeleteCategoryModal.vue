<template>
    <TransitionRoot :show="showDeleteCategoryModal" appear as="template">
...
<script setup>
    ...
    const showDeleteCategoryModal = computed({
        get: () => modalsStore.showDeleteCategoryModal,
        set: (value) => {
            modalsStore.showDeleteCategoryModal = value
        },
    })
    ...
    const deleteCategory = () => {
        categoriesStore.deleteCategory()
    }
</script>
